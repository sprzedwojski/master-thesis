...
% That information can be shared with third parties (with user consent) and can be used by them to improve user experience. [{\bf doszlifowac}]
...
% Next, this information can be processed in two ways:
% \begin{itemize}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\textwidth]{join_bomb.jpg} 
...
\footnotetext{Image source: \cite{learning_neo4j}, p.27}

% \hbox{}
% There are multiple challenges that will be faced in the course of this project. First, a reliable test user base will need to be created. For this a sample product catalog imitating a real store offer has to be created. Moreover, a web application allowing users to log in with 
...
% possibilities of commercial applications of the solution 



\chapter{Fundamental information on social commerce, recommendation algorithms and graph databases}
\chaptermark{Fundamental information on social commerce...}
...
% a more comprehensive variant of a social recommender system.
...
\begin{listing}
\begin{minted}[framesep=3mm,fontsize=\footnotesize,bgcolor=gray!20]{plpgsql}
...
\chaptermark{Presentation of existing social recommender...}
...
% Obviously, the system will improve over time, as more and more users with social data and product preferences are in the database.
...
\begin{figure}
\centering
\includegraphics[width=10cm]{graph_me2.png} 
...
\begin{figure}
\centering
\includegraphics[width=10cm]{graph_common2.png} 
...
% \begin{tabular}{|l|l|l|}
% \hline
% {\bf Recall} & {\bf Precision} & {\bf F-measure} \\ \hline
% 0.1052427836 & 0.3353535354    & 0.1445555053    \\ \hline
% \end{tabular}
% \end{table}
